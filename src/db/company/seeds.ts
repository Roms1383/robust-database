...
export const unit = next => {
  const create : Company = { _id: next, at_id: Types.ObjectId('000000000000000000000001'), name: "Another company", __v: 0 }
  const update : Company = { _id: next, at_id: Types.ObjectId('000000000000000000000001'), name: "Another company updated", __v: 0 }
